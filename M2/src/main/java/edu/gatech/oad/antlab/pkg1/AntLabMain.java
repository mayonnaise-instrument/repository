 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Jaemo Koo");
		  toPrint += p1.toString("jkoo39");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Sora Bang");
		  toPrint += p2.toString("sbang38");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alex McQuilkin");
		  toPrint += p3.toString("amcquilkin3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Brandon");
                  toPrint += p4.toString("byuan45");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Braxton");
                  toPrint += p5.toString("903340430");
